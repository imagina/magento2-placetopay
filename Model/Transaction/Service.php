...
namespace Imagina\Placetopay\Model\Transaction;
...
class Service
{
     ...
     */
    public function updateStatus($placetopayOrderId, $status, $close = false)
    {
        /**
         * @var $transaction \Magento\Sales\Model\Order\Payment\Transaction
         */
        $id = $this->transactionResource->getIdByPlacetpplOrderId($placetopayOrderId);
        if (!$id) {
            throw new LocalizedException(new Phrase('Transaction ' . $placetopayOrderId . ' not found.'));
        }
